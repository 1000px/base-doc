...
```html
  ...
  <el-table
    ...
    <el-table-column
      ...
      width="180">
      <template slot-scope="scope">
        <kc-popover trigger="hover" placement="top">
          <p>姓名: {{ scope.row.name }}</p>
          <p>住址: {{ scope.row.address }}</p>
          <div slot="reference" class="name-wrapper">
            <kc-tag size="medium">{{ scope.row.name }}</kc-tag>
          </div>
        </kc-popover>
      </template>
    </el-table-column>
    <el-table-column label="操作">
      <template slot-scope="scope">
        <kc-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">编辑</kc-button>
        <kc-button
          size="mini"
          type="danger"
    ...
    <el-table-column type="expand">
      <template slot-scope="props">
        <kc-form label-position="left" inline class="demo-table-expand">
          ...
          <kc-form-item label="所属店铺">
            <span>{{ props.row.shop }}</span>
          </kc-form-item>
          <kc-form-item label="商品 ID">
            <span>{{ props.row.id }}</span>
          </kc-form-item>
          <kc-form-item label="店铺 ID">
            <span>{{ props.row.shopId }}</span>
          </kc-form-item>
          <kc-form-item label="商品分类">
            <span>{{ props.row.category }}</span>
          </kc-form-item>
          <kc-form-item label="店铺地址">
            <span>{{ props.row.address }}</span>
          </kc-form-item>
          <kc-form-item label="商品描述">
