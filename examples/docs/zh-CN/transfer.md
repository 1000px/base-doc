...
```html
  <kc-transfer v-model="value1" :data="data"></kc-transfer>
...
```html
  ...
  <div style="text-align: center">
    <kc-transfer
      ...
      @change="handleChange"
      :data="data">
      <kc-button class="transfer-footer" slot="left-footer" size="small">操作</kc-button>
      <kc-button class="transfer-footer" slot="right-footer" size="small">操作</kc-button>
    </kc-transfer>
  </div>
