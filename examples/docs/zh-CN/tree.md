      ...
      renderContent(h, { node, data }) {
        return (
          <span class="custom-tree-node">
            ...
            <span>
              <kc-button size="mini" type="text" on-click={ () => this.append(data) }>Append</kc-button>
              <kc-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</kc-button>
            </span>
          </span>);
      },
...
:::demo
```html
<kc-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></kc-tree>
...
<div class="buttons">
  <kc-button @click="getCheckedNodes">通过 node 获取</kc-button>
  <kc-button @click="getCheckedKeys">通过 key 获取</kc-button>
  <kc-button @click="setCheckedNodes">通过 node 设置</kc-button>
  <kc-button @click="setCheckedKeys">通过 key 设置</kc-button>
  <kc-button @click="resetChecked">清空</kc-button>
</div>
