<template>
  <div class="kc-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <kc-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="kc-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="kc-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="kc-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="kc-time-spinner__arrow kc-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="kc-time-spinner__arrow kc-icon-arrow-down"></i>
        <ul class="kc-time-spinner__list" ref="hours">
          <li
            class="kc-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="kc-time-spinner__arrow kc-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="kc-time-spinner__arrow kc-icon-arrow-down"></i>
        <ul class="kc-time-spinner__list" ref="minutes">
          <li
            class="kc-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="kc-time-spinner__arrow kc-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="kc-time-spinner__arrow kc-icon-arrow-down"></i>
        <ul class="kc-time-spinner__list" ref="seconds">
          <li
            class="kc-time-spinner__item"
