<script>
	import { isDef } from '_src/utils/shared';
		...
		render(h) {
			...
			const hoverMenuHandler = e => {
				...
				if (e.target === hoverMenuRefs.activeItem) {
					...
					let temp = <path style="pointer-events: auto;" fill="transparent" d="M${offsetX} ${offsetYTop} L${width} 0 V${offsetYTop} Z" />
					let temp1 = <path style="pointer-events: auto;" fill="transparent" d="M${offsetX} ${offsetYBottom} L${width} ${height} V${offsetYBottom} Z" />
