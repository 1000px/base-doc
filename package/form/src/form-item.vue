<template>
	<div class="kc-form-item" :class="[{
      'kc-form-item--feedback': elForm && elForm.statusIcon,
      'is-error': validateState === 'error',
      'is-validating': validateState === 'validating',
      'is-success': validateState === 'success',
      'is-required': isRequired || required
    },
    sizeClass ? 'kc-form-item--' + sizeClass : ''
  ]">
		<label :for="labelFor" class="kc-form-item__label" v-bind:style="labelStyle" v-if="label || $slots.label">
			<slot name="label">{{label + form.labelSuffix}}</slot>
		</label>
		<div class="kc-form-item__content" v-bind:style="contentStyle">
			<slot></slot>
			<transition name="kc-zoom-in-top">
				<div
					v-if="validateState === 'error' && showMessage && form.showMessage"
					class="kc-form-item__error"
					:class="{
            'kc-form-item__error--inline': typeof inlineMessage === 'boolean'
              ? inlineMessage
...
<script>
	...
	import {noop, getPropByPath} from '_src/utils/util';
